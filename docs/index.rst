...
The goals of this primer are to teach researchers about the motivation, goals, principles, and methods of WC modeling and to prepare researchers to contribute to WC modeling. Toward this goal, the primer includes introductory readings and hands-on tutorials on WC modeling, the fundamental principles and methods of cell modeling, computer programming and software engineering, Linux computer systems, and scientific communication. :numref:`Part %s <introduction>` introduces the motivation, goals, and fundamental challenges of WC modeling; describes why WC modeling is becoming feasible; summarizes the principles and methods of WC modeling; reviews the latest WC models and their limitations; outlines the major bottlenecks to WC modeling; proposes a plan for achieving WC models as a community; and describes ongoing work to advance WC modeling. :numref:`Part %s <fundational_concepts_and_skills>` introduces several foundational concepts and skills for WC modeling including computer programming, Linux computer systems, and scientific communication. :numref:`Part %s <cell_modeling>` outlines the theoretical foundations for WC modeling. :numref:`Part %s <wc_modeling>` describes the principles and methods of WC modeling. :numref:`Part %s <funding>` outlines several funding opportunities for WC modeling.
